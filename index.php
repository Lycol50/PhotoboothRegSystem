            ...
            <form action="action.php" method="post">
                ...
                <div class="mb-3">  
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label for="option" class="form-label">1 Shot : 10 Pesos (with frame and props)</label></div>
                  <div class="form-check">  
                    <input class="form-check-input" type="radio" id="2shot" name="option" value="2shot">
                    <label class="form-check-label for="option" class="form-label">2 Shot : 20 Pesos (with frame and props)</label></div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" id="4shot" name="option" value="4shot">
                    <label class="form-check-label for="option" class="form-label">4 Shot : 50 Pesos (with frame and props)</label></div>
                </div>

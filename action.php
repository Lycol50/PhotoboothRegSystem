...
function onEmailSend(string $num)
{
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <h2> This is your serial number for Photobooth : ' .
        ...
        ' </h2>
    <p>
    Please present this code to the booth to proceed with picture taking. To get the pictures, please approach to Registration booth to recieve pictures to your Informatics Email. 
    </p>
    </td> 
    </tr>
    </table>
...
// Database connection
$conn = new mysqli("address", "username", "password", "database"); // change to your database
if ($conn->connect_error) {
    die("Connection Failed : " . $conn->connect_error);
} else {
    $stmt = $conn->prepare(
        "insert into photobooth_data (serial, name, email, optionPhoto) values (?, ?, ?, ?)"
    );
    $stmt->bind_param("ssss", $serial, $name, $email, $optionPhoto);
    $stmt->execute();
     ...
     <tr>
       <td>
        <h2> This is your serial number for Photobooth : <?php echo $serial; ?></h2>
            <p>
              Please present this code to the booth to proceed with picture taking. To get the pictures, please approach to Registration booth to recieve pictures to your Informatics Email. (This confirmation is sent to your email.)
            </p>
          </td> 
          </tr>
                 </table>

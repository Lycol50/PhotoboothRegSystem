...
<body bgcolor="#F5F8FA" style="width: 100%; margin: auto 0; padding:0; font-family:Lato, sans-serif; font-size:18px; color:#33475B; word-break:break-word">
  ...
  function onEmailSend(string $num)
  {
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <tr>
    <td>
    <h2> Your Photos are now ready! </h2>
    <p><b><u>Note: This is a zip file, you need to unzip it to get all pictures.</u></b></p>
    <p>
  ...
  $async->addTimer(1, function () {
      ...
      if ($conn->connect_error) {
          ...
          // get email from db
          $stmt = $conn->prepare(
              "select email from foundation_photobooth where serial = ?"
          );
          ...
          if ($stmt_result->num_rows > 0) {
              ...
              // zip all photos from $serial directory
              if ($zip->open("pictures/$serial/$serial.zip", ZipArchive::CREATE) === true) {
              ...
              $mail->addAttachment("pictures/$serial/$serial.zip");
              $mail->send();
          }
          $stmt->close();
          $conn->close();
      ...
      <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 30px 60px;">
         <tr>
           <td>
            ...
            <div class="mb-3">
            <a href="http://localhost/photobooth/sendphoto.php"><button class="btn btn-primary">Go Back</button></a>
            </div>
              </td> 
              </tr>
      </table>';
